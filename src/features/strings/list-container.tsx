...
import { createItem } from "@/src/app/utils";
...
const ListContainer = () => {
  ...
  return (
    <div className="flex-col justify-self-center items-center w-[900px] h-[577px] bg-white bg-no-repeat bg-origin-padding shadow-[0px_5px_12px_#0000001F] rounded-[20px] p-[50px]">
      <div className="w-[800px]">
        <h1 className="  h-[49px] text-center text-[40px] leading-[44px] font-medium tracking-[0px]  opacity-100 ">
